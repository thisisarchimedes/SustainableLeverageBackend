...
export interface PositionTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "approve"
...
export interface PositionToken extends BaseContract {
  connect(runner?: ContractRunner | null): PositionToken;
  ...
  setTokenURI: TypedContractMethod<[uri: string], [void], "nonpayable">;
