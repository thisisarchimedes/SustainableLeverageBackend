...
export declare namespace LeveragedStrategy {
  export type StrategyConfigStruct = {
    quota: BigNumberish;
    positionLifetimeInBlocks: BigNumberish;
  ...
  export type StrategyConfigStructOutput = [
    quota: bigint,
    positionLifetimeInBlocks: bigint,
...
export interface LeveragedStrategyInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getPositionLifetimeInBlocks",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "positionLedger",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "protocolParameters",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface LeveragedStrategy extends BaseContract {
  ...
  getPositionLifetimeInBlocks: TypedContractMethod<
    [strategy: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getStrategyConfig: TypedContractMethod<
    [strategy: AddressLike],
    [LeveragedStrategy.StrategyConfigStructOutput],
    "view"
  >;
  ...
  positionLedger: TypedContractMethod<[], [string], "view">;
  ...
  protocolParameters: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getPositionLifetimeInBlocks"
  ): TypedContractMethod<[strategy: AddressLike], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getStrategyConfig"
  ): TypedContractMethod<
    [strategy: AddressLike],
    [LeveragedStrategy.StrategyConfigStructOutput],
    "view"
